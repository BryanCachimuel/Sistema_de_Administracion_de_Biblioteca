...
<form action="<?php print RUTA; ?>login/registroConfirmar/" method="POST">
	<div class="form-group text-left">
		...
		<input type="password" name="clave" id="clave" class="form-control" placeholder="Escribe la clave de acceso que se te envió por correo electrónico." value="" required>
	</div>
