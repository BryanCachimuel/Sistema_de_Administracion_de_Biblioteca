<?php include("encabezado.php"); ?>
  ...
  <tbody>
    ...
    for($i=0; $i<count($datos['data']); $i++){
      ...
      print "<td><a href='".RUTA."libros/copias/".$datos["data"][$i]["id"]."/".$datos["pag"]["pagina"]."' class='btn btn-warning'>Copias</a></td>";
      print "<td><a href='".RUTA."libros/librosAutores/".$datos["data"][$i]["id"]."/".$datos["pag"]["pagina"]."' class='btn btn-warning'>Autor(es)</a></td>";
