<?php include_once("encabezado.php"); ?>
    ...
    <div class="form-group text-left mt-3">
        <a href="<?php print RUTA; ?>autores/autoresLibrosBajaLogica/<?php print $datos['id'].'/'.$datos['pag'].'/'.$datos['data']['idLibro']; ?>" class="btn btn-danger">Quitar la relación autor-libro</a>
