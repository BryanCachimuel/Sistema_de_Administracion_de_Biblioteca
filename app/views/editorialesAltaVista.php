  ...
  <form action="<?php print RUTA; ?>editoriales/alta/" method="POST">
   ...
   <div class="form-group text-left">
    ...
    <div class="form-group text-left">
      ...
      <input type="url" name="pagina" id="pagina" class="form-control" required value="<?php print isset($datos['data']['pagina'])?$datos['data']['pagina']:''; ?>" <?php if (isset($datos["baja"])) { print " disabled "; }?> placeholder="www.paginaweb.com">
    </div>
    ...
    <div class="form-group text-left">
      ...
      <select class="form-control" name="idPais" id="idPais" 
          ...
          >
          <option value="void">---Selecciona una país---</option>
          <?php
