<?php include("encabezado.php"); ?>
    <form action="<?php print RUTA; ?>login/cambiarClave" method="POST">
        <div class="form-group text-left">
			<label for="clave">* Nueva Contraseña de acceso:</label>
			<input type="password" name="clave" class="form-control" placeholder="Escribe tu Nueva contraseña de acceso." required>
		</div>
		<div class="form-group text-left">
